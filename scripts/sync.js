...
function usage() {
  ...
  console.log('masternodes  Masternodes data: detailed list of masternodes');
  console.log('');
      ...
      mongoose.connect(dbString, { useMongoClient: true }, function(err) {
        if (err) {
          ...
          if (!settings.masternodes.enabled) {
            console.log('masternodes not enabled.');
            exit();
          }

          db.update_masternodes_db(function(err) {
            console.log('masternodes data updated successfully.');
            exit();
          });
        }
      });
